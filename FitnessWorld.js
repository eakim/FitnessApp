      ...
      <View style={styles.section}>
        ...
        <ScrollView horizontal showHorizontalScrollIndicator={false}>
            <View style={styles.trainingTypeCard}>
                <Image style={styles.trainingImage} source={{ uri: 'https://images.unsplash.com/photo-1589579234096-25cb6b83e021?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }} />
